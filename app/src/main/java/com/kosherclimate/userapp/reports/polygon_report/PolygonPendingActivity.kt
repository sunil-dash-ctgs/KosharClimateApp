...
class PolygonPendingActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        progress = SweetAlertDialog(this@PolygonPendingActivity, SweetAlertDialog.PROGRESS_TYPE)
...
// Disabling Prev button in start
        ...
        bNext.setOnClickListener(View.OnClickListener {
            ...
            if(startIndex >= size){
                ...
                if(endIndex!! >= size ){
                    ...
                    pipe_recyclerView.layoutManager = LinearLayoutManager(this@PolygonPendingActivity)
                    pipeReportAdapter.notifyDataSetChanged()
                    ...
                    Toast.makeText(this@PolygonPendingActivity, "Last Page", Toast.LENGTH_SHORT).show()
                }
                else{
        ...
        bBack.setOnClickListener(View.OnClickListener {
            ...
            if(startIndex < 1){
                ...
                Toast.makeText(this@PolygonPendingActivity, "First Page", Toast.LENGTH_SHORT).show()
            }
            else{
