...
import com.kosherclimate.userapp.farmeronboarding.PlotActivity
import com.kosherclimate.userapp.models.DistrictModel
import java.text.DecimalFormat

class ExistingLocationActivity : AppCompatActivity(), LocationListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        progress = SweetAlertDialog(this@ExistingLocationActivity, SweetAlertDialog.PROGRESS_TYPE)
        ...
        state_spinner = findViewById(R.id.state_exi)
        district_spinner = findViewById(R.id.district_exi)
        taluka_spinner = findViewById(R.id.taluka_exi)
        village_spinner = findViewById(R.id.village_exi)
        panchayat_spinner = findViewById(R.id.panchayat_exi)

        val locationIcon = findViewById<LinearLayout>(R.id.location_icon_exi)

        val next = findViewById<Button>(R.id.location_Next_exi)
        val back = findViewById<Button>(R.id.location_back_exi)

        txtAddress = findViewById(R.id.remark_exi)
        txtLatitude = findViewById(R.id.latitude_exi)
        txtLongitude = findViewById(R.id.longitude_exi)
// Remove before giving to client.
        ...
        next.setOnClickListener {
            val WarningDialog =
                SweetAlertDialog(this@ExistingLocationActivity, SweetAlertDialog.WARNING_TYPE)
        ...
        locationIcon.setOnClickListener {
            val active = isLocationEnabled(this@ExistingLocationActivity)
            ...
            if (active) {
                ...
                AlertDialog.Builder(this@ExistingLocationActivity)
                    .setMessage(R.string.gps_network_not_enabled)
                    .setPositiveButton(R.string.yes,
                        DialogInterface.OnClickListener { paramDialogInterface, paramInt ->
                            this@ExistingLocationActivity.startActivity(
        ...
        if(adb == 1) {
            AlertDialog.Builder(this@ExistingLocationActivity)
                ...
                .setPositiveButton(R.string.clcik_disable,
                    DialogInterface.OnClickListener { paramDialogInterface, paramInt ->
                        this@ExistingLocationActivity.startActivity(Intent(Settings.ACTION_APPLICATION_DEVELOPMENT_SETTINGS))
                    })
                .show()
        }
    }
    ...
    private fun sendData() {
        ...
        retIn.existingFarmerLocation("Bearer $token", farmerLocationModel).enqueue(object : Callback<ResponseBody> {
...
//            19.201641,72.861155
    ...
    private fun nextScreen() {
        progress.dismiss()
        Log.i("plot_number","plot_number $existingPlots in existing plot activity")
        val intent = Intent(this, ExistingPlotActivity::class.java).apply {
            ...
            putExtra("existing_plot", existingPlots)
