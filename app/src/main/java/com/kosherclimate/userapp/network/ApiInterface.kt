...
interface ApiInterface {
    ...
    fun subPlotId(
        @Header("Authorization") token: String,
        @Query("farmer_uniqueId") farmer_uniqueId: String
    ): Call<ResponseBody>
    ...
    fun plotDetails(
        ...
        @Query("farmer_plot_uniqueid") farmer_plot_uniqueid: String,
        @Query("plot_no") plot_no: String
    ): Call<ResponseBody>


    @Headers("Accept: application/json")
    @GET("V1/farmer/benefits/detail")
    fun farmerPlotDetails(
        @Header("Authorization") token: String,
        @Query("farmer_plot_uniqueid") farmer_plot_uniqueid: String,
        @Query("farmer_uniqueId") farmer_uniqueId: String,
        @Query("plot_no") plot_no: String
    ...
    fun sendCropData(
        @Header("Authorization") token: String,
        @Body cropInfoModel: CropInfoModel
    ): Call<ResponseBody>
    ...
    fun farmerInfo(
        @Header("Authorization") token: String,
        @Body farmerInfoModel: FarmerInfoModel
    ): Call<ResponseBody>

    @Headers("Accept: application/json")
    @POST("V1/onboarding/data")
    fun addExistingPlots(
        @Header("Authorization") token: String,
        @Body farmerInfoModel: FarmerInfoModelNew
    ): Call<ResponseBody>
    ...
    fun imageUpload(
        @Header("Authorization") token: String,
        @Part farmer_id: MultipartBody.Part,
        @Part farmer_unique_id: MultipartBody.Part,
    ...
    fun benefitImageUpload(
        @Header("Authorization") token: String,
        @Part farmer_id: MultipartBody.Part,
        @Part farmer_uniqueId: MultipartBody.Part,
        @Part plot_no: MultipartBody.Part,
        @Part farmer_benefit_id: MultipartBody.Part,
        @Part image: MultipartBody.Part
    ): Call<ResponseBody>
    ...
    fun sendBenefitData(
        @Header("Authorization") token: String,
        @Body benefitModel: BenefitModel
    ): Call<ResponseBody>


    @Headers("Accept: application/json")
    @POST("V1/farmer/benefits/check")
    fun checkBenefitData(
        @Header("Authorization") token: String,
        @Body benefitCheckModel: BenefitCheckModel
    ): Call<ResponseBody>
    ...
    fun newDistrict(
        @Header("Authorization") token: String,
        @Body districtModel: DistrictModel
    ): Call<ResponseBody>
    ...
    fun farmerLocation(
        @Header("Authorization") token: String,
        @Body farmerLocationModel: NewFarmerLocationModel
    ): Call<ResponseBody>

    @Headers("Accept: application/json")
    @POST("V1/onboarding/store/location")
    fun existingFarmerLocation(
        @Header("Authorization") token: String,
        @Body farmerLocationModel: FarmerLocationModel
    ): Call<ResponseBody>
    ...
    fun plotInfo(
        ...
        @Part farmer_id: MultipartBody.Part,
        @Part farmer_unique_id: MultipartBody.Part,
        @Part land_ownership: MultipartBody.Part,
        @Part actual_owner_name: MultipartBody.Part,
        @Part patta_number: MultipartBody.Part,
        @Part daag_number: MultipartBody.Part,
        @Part khatha_number: MultipartBody.Part,
        @Part pattadhar_number: MultipartBody.Part,
        @Part khatian_number: MultipartBody.Part,
        @Part sign_affidavit: MultipartBody.Part,
        @Part survey_no: MultipartBody.Part,
        @Part check_carbon_credit: MultipartBody.Part,
    ...
    fun existingPlotInfo(
        ...
        @Part survey_no: MultipartBody.Part,
        @Part check_carbon_credit: MultipartBody.Part,
        @Part area_other_awd: MultipartBody.Part,
        @Part area_acre_awd: MultipartBody.Part,
        @Part signature: MultipartBody.Part
    ): Call<ResponseBody>
    ...
    fun lastScreen(
        @Header("Authorization") token: String,
        @Part screen: MultipartBody.Part,
        @Part farmer_id: MultipartBody.Part,
        @Part date_survey: MultipartBody.Part,
        @Part time_survey: MultipartBody.Part,
        @Part farmer_photo: MultipartBody.Part,
        @Part aadhaar_photo: MultipartBody.Part,
        @Part others_photo: MultipartBody.Part,
        @Part plotowner_sign: MultipartBody.Part,
        @Part farmer_uniqueId: MultipartBody.Part,
        @Part signature: MultipartBody.Part,
        @Part financial_year: MultipartBody.Part,
    ...
    fun registrationReportList(
        @Header("Authorization") token: String,
        @Body statusModel: StatusModel
    ): Call<ResponseBody>
    ...
    @Headers("Accept: application/json")
    @POST("")
    fun registrationReportPagination(
        @Header("Authorization") token: String,
        @Url url: String,
        @Body statusModel: StatusModel
    ): Call<ResponseBody>
...
//    @GET("V1/user/farmer/registration/search")
    ...
    fun onBoardingReportDetail(
        @Header("Authorization") token: String,
        @Body farmerIDModel: FarmerIDModel
    ): Call<ResponseBody>
    ...
    fun reUploadImage(
        ...
        @Part farmer_unique_id: MultipartBody.Part,
        @Part farmer_id: MultipartBody.Part,
        @Part plotno: MultipartBody.Part,
        @Part image: MultipartBody.Part,
        @Part season: MultipartBody.Part,
        @Part financial_year: MultipartBody.Part
    ): Call<ResponseBody>
    ...
    fun rejectReason(
        @Header("Authorization") token: String,
        @Path("unique_id") unique_id: String,
        @Path("plot_no") plot_no: String
    ): Call<ResponseBody>


    @Headers("Accept: application/json")
    @POST("V1/user/farmer/registration/update")
    fun submitNumberRejectReason(
        @Header("Authorization") token: String,
        @Body reuploadModel: SurveyNumberReUploadModel
    ): Call<ResponseBody>


    @Headers("Accept: application/json")
    @POST("V1/user/farmer/registration/update")
    fun submitAreaRejectReason(
        @Header("Authorization") token: String,
        @Body reuploadModel: AreaReUploadModel
    ): Call<ResponseBody>


    @Headers("Accept: application/json")
    @POST("V1/user/farmer/registration/update")
    fun submitNameRejectReason(
        @Header("Authorization") token: String,
        @Body reuploadModel: NameReUploadModel
    ): Call<ResponseBody>
    ...
    fun farmerPipeDetails(
        @Header("Authorization") token: String,
        @Body farmerUniqueIdModel: FarmerUniqueIdModel
    ): Call<ResponseBody>
    ...
    fun sendPipeData(
        @Header("Authorization") token: String,
        @Body pipeLocationModel: PipeLocationModel
    ): Call<ResponseBody>
    ...
    fun getPipeQty(
        @Header("Authorization") token: String,
        @Body pipeQtyModel: PipeQtyModel
    ): Call<ResponseBody>
    ...
    fun sendPipeLastData(
        @Header("Authorization") token: String,
        @Part farmer_id: MultipartBody.Part,
        @Part farmer_plot_uniqueid: MultipartBody.Part,
        @Part farmer_unique_id: MultipartBody.Part,
        @Part plot_no: MultipartBody.Part,
        @Part lat: MultipartBody.Part,
        @Part lng: MultipartBody.Part,
        @Part pipe_no: MultipartBody.Part,
        @Part distance: MultipartBody.Part,
        @Part installing_pipe: MultipartBody.Part,
    ...
    fun checkPipeStatus(
        @Header("Authorization") token: String, @Query("farmer_uniqueId") farmer_uniqueId: String,
        @Query("plot_no") plot_no: String
    ): Call<ResponseBody>
    ...
    fun checkCoordinates(
        @Header("Authorization") token: String,
        @Body checkPolygonModel: CheckPolygonModel
    ): Call<ResponseBody>
    ...
    fun updatePipePolygon(
        @Header("Authorization") token: String,
        @Body updatePolygonModel: UpdatePolygonModel
    ): Call<ResponseBody>
    ...
    fun pipeReUploadImage(
        ...
        @Part lng: MultipartBody.Part,
        @Part distance: MultipartBody.Part,
        @Part pipe_img_id: MultipartBody.Part,
        @Part images: MultipartBody.Part,
        @Part financial_year: MultipartBody.Part,
        @Part season: MultipartBody.Part
    ): Call<ResponseBody>
    ...
    fun farmerReUploadImage(
        @Header("Authorization") token: String,
        @Part farmer_uniqueId: MultipartBody.Part,
        @Part farmer_photo: MultipartBody.Part,
        @Part reason_id: MultipartBody.Part,
        @Part financial_year: MultipartBody.Part,
        @Part season: MultipartBody.Part,
        @Part plotno: MultipartBody.Part,
        @Part aadhaar_photo: MultipartBody.Part,
    ...
    fun aeriationPloygonList(
        @Header("Authorization") token: String,
        @Query("farmer_plot_uniqueid") farmer_plot_uniqueid: String,
        @Query("pipe_no") pipe_no: String
    ): Call<ResponseBody>
    ...
    fun aeriationPloygonList(
        ...
        @Query("farmer_plot_uniqueid") farmer_plot_uniqueid: String,
        @Query("pipe_no") pipe_no: String,
        @Query("aeration_no") aeration_no: String
    ): Call<ResponseBody>
    ...
    fun sendAeriationData(
        @Header("Authorization") token: String,
        @Part pipe_installation_id: MultipartBody.Part,
        @Part farmer_uniqueId: MultipartBody.Part,
        @Part farmer_plot_uniqueid: MultipartBody.Part,
        @Part plot_no: MultipartBody.Part,
        @Part aeration_no: MultipartBody.Part,
        @Part pipe_no: MultipartBody.Part,
        @Part financial_year: MultipartBody.Part,
        @Part season: MultipartBody.Part
    ): Call<ResponseBody>
    ...
    fun getListOfPolygon(
        @Header("Authorization") token: String,
        @Body latLong: LatLongModel
    ): Call<ResponseBody>
    ...
    fun getPlotId(
        @Header("Authorization") token: String,
        @Query("farmer_uniqueId") data: String
    ): Call<ResponseBody>
    ...
    fun verifyMobile(
        @Header("Authorization") token: String,
        @Query("phone_number") data: String
    ): Call<ResponseBody>

    /*** Get List Of Plots near Me*/
    @Headers("Accept: application/json")
    @POST("V1/farmer_details")
    fun getFarmerLocation(
        @Header("Authorization") token: String,
        @Body farmer_uniqueId: FarmerIDModel
    ): Call<ResponseBody>
    ...
    fun getFarmerDetails(
        @Header("Authorization") token: String,
        @Query("farmer_uniqueId") farmerUniqueId: String,
    ...
    fun updateFarmerPersonalDetails(
        @Header("Authorization") token: String,
        @Body personalDetails: UpdatedPersonalDetails,
    ): Call<ResponseBody>
    ...
    fun updateFarmerLocation(
        @Header("Authorization") token: String,
        @Body farmerLocationModel: UpdatedFarmerLocation
    ): Call<ResponseBody>
    ...
    fun polygonUpdateFarmerArea(
        @Header("Authorization") token: String,
        @Body updateFarmerAreaModel: UpdateFarmerAreaModel
    ): Call<ResponseBody>
